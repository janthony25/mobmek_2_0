...
public class CashFlowSettingsServiceTests
{
    ...
    public async Task GetCurrentAsync_CreatesEmptySingletonOnFirstUse()
    {
        ...
        var service = new CashFlowSettingsService(db, new CashFlowAuditService(db));
    ...
    public async Task UpdateAsync_StoresRouting()
    {
        ...
        var updated = await service.UpdateAsync(new UpdateCashFlowSettingsRequest(bank.Id, till.Id, bank.Id, bank.Id, 5000m, null));
        ...
        Assert.Equal(5000m, updated.SafetyBufferAmount);
    }
    ...
    public async Task UpdateAsync_ReturnsNull_WhenAnyAccountIdUnknown()
    {
        ...
        var updated = await service.UpdateAsync(new UpdateCashFlowSettingsRequest(Guid.NewGuid(), null, null, null, 0m, null));
